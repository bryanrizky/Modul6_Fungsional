...
gambarku = Image.open(r"D:\Semester 5\FUNGSIONAL\latihanmodul6\b2.jpeg")
...
direktoriFont = r"D:\Semester 5\FUNGSIONAL\latihanmodul6\RED BURGER.otf"  # Ganti dengan direktori font yang sudah kamu unduh
size = 24
font = ImageFont.truetype(direktoriFont, size)
text = "Nama: Bryan Rizky Maulana\nNIM: 202110370311390"
